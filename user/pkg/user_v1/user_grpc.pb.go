...
func (c *userV1Client) List(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*ListResponse, error) {
...
func (UnimplementedUserV1Server) List(context.Context, *empty.Empty) (*ListResponse, error) {
...
func _UserV1_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserV1Server).List(ctx, req.(*empty.Empty))
	}
